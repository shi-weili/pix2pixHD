...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--normG', type=str, default='instance', help='instance | batch | batch_renorm')    
        self.parser.add_argument('--normD', type=str, default='instance', help='instance | batch | batch_renorm')
        self.parser.add_argument('--normE', type=str, default='instance', help='instance | batch | batch_renorm')       
        ...
        self.parser.add_argument('--target', type=str, default='bm_land_ocean', help='Which Blue Marble version to use [bm | bm_enhanced | bm_land_ocean | bm_land_ocean_ice | night | clouds]')
